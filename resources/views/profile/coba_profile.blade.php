...
<div class="col-md-6 col-lg-12">
    <div class="card h-100" style="width: 700px; margin: auto;">
    ...
    <div class="container mt-3">
        ...
        src="{{ isset($user['photo']) && $user['photo'] ? (rtrim(env('API_URL'), '/api') . '/assets/photo_profile/' . $user['photo']) : 'default_photo_url_here' }}">  --}}
                ...
                @if (isset($user['photo']) && $user['photo'])
                    ...
                    <img id="previewPhoto" class="rounded-circle shadow-sm border" style="width: 100px; height: 100px;" alt="Profile Photo" src="{{ session('photo') ? (($apiUrl = rtrim(env('API_URL'), '/api')) ? $apiUrl . '/assets/photo_profile/' . session('photo') : 'default_photo_url_here') : 'default_photo_url_here' }}">
                @else
                    ...
                    <a class="nav-link dropdown-toggle d-flex align-items-center" href="javascript:void(0)"
                        ...
                        <i class="fas fa-user-circle" 
                            style="font-size: 80px; color: #ac2daa; border: 1px solid #ac2daa; padding: 2px; border-radius: 50%;"></i>
            ...
            <div class="mt-3 text-center">
                <label for="profile_photo" class="btn btn-primary fw-bold" style="border-radius: 90px; background-color: purple; border: none;">
                    Change photo
                </label>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body text-center">
                        <img id="modalPreviewPhoto" class="rounded-circle border mb-3" width="150" height="150"
                            alt="Preview Photo">
        ...
        <form method="POST" action="{{ route('profile.update') }}" id="profileForm">
            ...
            <div class="mb-3">
                ...
                <div class="input-group">
                    <input type="text" style="border-radius: 6px;" class="form-control ps-5" name="name"
            ...
            <div class="mb-3">
                ...
                <div class="input-group">
                    <input type="text" style="border-radius: 6px;" class="form-control ps-5 border-none focus:ring-0"
            ...
            <div class="mb-3" style="margin-top: 20px;">
                ...
                <div class="input-group">
                    ...
                    <svg style="padding-left: 8px;" class="position-absolute top-50 start-0 translate-middle-y ms-2"
                ...
                <div class="mb-3" style="margin-top: 15px;">
                    <label style="color: #7e7a7a;" for="password_confirmation" class="form-label">Confirm New
                        Password</label>
                    <div class="input-group">
                    ...
                    <button type="submit" class="btn btn-primary mt-3" id="submitButton" style="border-radius: 5px; background-color: purple; border: none;">
                        Edit Profil

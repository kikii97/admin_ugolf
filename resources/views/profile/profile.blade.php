...
<div class="text-center mb-4" style="margin-top: 30px;">
    <div class="d-inline-block position-relative">
        <img id="previewPhoto" class="rounded-circle shadow-sm border" width="100" height="100" alt="Profile Photo" src="{{ session('photo') ? (($apiUrl = rtrim(env('API_URL'), '/api')) ? $apiUrl . '/assets/photo_profile/' . session('photo') : 'default_photo_url_here') : 'default_photo_url_here' }}">
    </div>
